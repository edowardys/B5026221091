<html lang="en">
    <head>
        <title>5026221091_Edward Yosafat Sirait</title>
    ...
    <body>
        <div class="container-fluid">
            ...
            <input type="button" value="Penjumlahan" class="btn btn-success">
            <input type="button" value="Perkalian" class="btn btn-warning">
        </div>
    </body>
</html>